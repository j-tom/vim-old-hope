...
call oldhope#SetHi ("CursorLineNr"  , s:vBlue         , s:vBg           , s:vBold      )
call oldhope#SetHi ("CursorLine"    , s:vNone         , s:vDarkGrey     , s:vNone      )
call oldhope#SetHi ("CursorColumn"  , s:vNone         , s:vDarkGrey     , s:vNone      )
call oldhope#SetHi ("ColorColumn"   , s:vNone         , s:vDarkGrey     , s:vNone      )
