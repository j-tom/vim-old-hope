...
let s:tco16Black          = 0
let s:tco16Red            = 9
let s:tco16DarkRed        = 1
let s:tco16Yellow         = 11
let s:tco16DarkYellow     = 3
let s:tco16Green          = 10
let s:tco16DarkGreen      = 2
let s:tco16Blue           = 12
let s:tco16DarkBlue       = 4
let s:tco16Cyan           = 14
let s:tco16DarkCyan       = 6
let s:tco16Magenta        = 13
let s:tco16DarkMagenta    = 5
" }}}
